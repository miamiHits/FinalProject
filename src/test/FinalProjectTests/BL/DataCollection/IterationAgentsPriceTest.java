...
public class IterationAgentsPriceTest {
    ...
    public void setUp() throws Exception {
        ...
        l1.add(new AgentPrice("a1", 22.22, consumptionPerTick, 1245));
        List<AgentPrice> l2 = new LinkedList<AgentPrice>();
        l2.add(new AgentPrice("a1", 22.22, consumptionPerTick, 1245));
        l2.add(new AgentPrice("a2", 33.33, consumptionPerTick, 1245));
