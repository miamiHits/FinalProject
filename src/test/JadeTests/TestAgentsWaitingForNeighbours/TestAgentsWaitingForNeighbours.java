package JadeTests.TestAgentsWaitingForNeighbours;
...
public class TestAgentsWaitingForNeighbours extends AbstractJadeIntegrationTest
{
    ...
    public Behaviour load(Agent a) throws TestException
    {
        ...
        return new TestDataCollectionCommunicatorBehaviour(this, messagesReceivedFromAgents);// Create the Behaviour actually performing the test
    }
