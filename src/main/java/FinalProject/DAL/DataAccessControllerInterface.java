...
public interface DataAccessControllerInterface {
    ...
    boolean saveResults(Map<String, List<Double>> powerConsumption, Map<String, List<Double>> totalPowerConsumptionAnyTime, Map<String, List<Double>> highestAgent, Map<String, List<Double>> totalPowerConsumption, Map<String, List<Long>> averageTimePerIter, Map<String, Long> totalMessagesSize, Map<String, Long> totalAverageMessages, List<AlgorithmProblemResult> experimentResults);
}
